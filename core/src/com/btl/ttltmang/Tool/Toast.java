...
public class Toast {
	...
	public Toast(
		...
		margin = customMargin == null ? lineHeight * 2 : customMargin;
	...
	public boolean render(float delta) {
		...
		renderer.circle(positionX, this.margin/2+10 + toastHeight / 2, toastHeight / 2);
		renderer.rect(positionX, this.margin/2+10, toastWidth, toastHeight);
		renderer.circle(positionX + toastWidth, this.margin/2+10 + toastHeight / 2, toastHeight / 2);
		renderer.end();
